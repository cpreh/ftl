  ...
  return libftl::sprite::object{
      ...
      sge::sprite::roles::size_or_texture_size{} =
          libftl::sprite::size_or_texture_size{libftl::sprite::object::dim{
              fcppt::cast::size<libftl::sprite::object::unit>(_resources.ship_root_->img().w()),
              fcppt::cast::size<libftl::sprite::object::unit>(_resources.ship_root_->img().h())}},
        ...
        return libftl::sprite::object{
            sge::sprite::roles::pos{} =
                libftl::sprite::object::vector{
                    fcppt::cast::size<libftl::sprite::object::unit>(_floor.get().offset_.x()),
                    fcppt::cast::size<libftl::sprite::object::unit>(_floor.get().offset_.y())},
            sge::sprite::roles::size_or_texture_size{} =
...
libftl::ship::draw(libftl::sprite::images const &_images, libftl::ship::resources const &_resources)
{
  return fcppt::container::join(
      ...
      libftl::impl::room::draw(_images, *_resources.ship_root_, _resources.layout_));
}
