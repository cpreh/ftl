...
private:
  [[nodiscard]] static fcppt::either::object<libftl::xml::type_error, map>
  make_map(std::vector<libftl::impl::xml::attribute> const &_args)
  {
    return fcppt::algorithm::fold(
        _args,
        fcppt::either::make_success<libftl::xml::type_error>(map{}),
        [](libftl::impl::xml::attribute const &_arg, fcppt::either::object<libftl::xml::type_error, map> &&_map)
        {
          return fcppt::either::bind(
              std::move(_map),
              [&_arg](map &&_inner_map)
              {
                ...
                {
                  return fcppt::either::make_failure<map>(
                      libftl::xml::type_error{libftl::xml::type_error::variant{
                          libftl::xml::errors::multi_attribute{name}}});
                }
                _inner_map.insert(std::make_pair(name, fcppt::make_cref(_arg)));
                return fcppt::either::make_success<libftl::xml::type_error>(std::move(_inner_map));
              });
        });
  }
          ...
          return fcppt::either::construct(
              ...
              [&unused_keys]
              {
                return libftl::xml::type_error{libftl::xml::type_error::variant{
                    libftl::xml::errors::unused_attributes{std::move(unused_keys)}}};
              });
        });
  }
        ...
        [&name]() -> fcppt::either::object<libftl::xml::type_error, parser_result>
        {
          ...
          else
          {
            return fcppt::either::make_failure<parser_result>(libftl::xml::type_error{
                libftl::xml::type_error::variant{libftl::xml::errors::missing_attribute{name}}});
          }
        },
        [_used, &name, this](
            fcppt::reference<fcppt::reference<libftl::impl::xml::attribute const> const> const
                _mapped) -> fcppt::either::object<libftl::xml::type_error, parser_result>
        {
          _used->insert(name);
          return fcppt::either::bind(
