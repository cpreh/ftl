#ifndef LIBFTL_IMPL_XML_TYPED_OPTIONAL_INNER_NODE_HPP_INCLUDED
#define LIBFTL_IMPL_XML_TYPED_OPTIONAL_INNER_NODE_HPP_INCLUDED
...
public:
  ...
  parse(fcppt::optional::object<libftl::impl::xml::inner_node> const &_node) const
  {
    return fcppt::optional::maybe(
        _node,
        [] { return fcppt::either::make_success<libftl::xml::type_error>(result_type{}); },
...
template<typename Parser>
optional_inner_node(Parser &&) -> optional_inner_node<Parser>;
}
