      ...
      fcppt::either::from_optional(
          ...
          [this]
          {
            return libftl::archive::open_path_error{libftl::archive::open_path_error::variant{
                libftl::archive::open_path_error::failed_to_open{this->file_path_}}};
          }),
      ...
      [&_path, this](std::ifstream &&_stream)
      {
        return fcppt::either::bind(
            fcppt::either::from_optional(
                ...
                {
                  return libftl::archive::open_path_error{libftl::archive::open_path_error::variant{
                      libftl::archive::open_path_error::missing_path{
                          .archive_path_ = _path, .file_path_ = this->file_path_}}};
                }),
            [&_path, this, &_stream](fcppt::reference<libftl::archive::entry const> const _entry)
            {
              return fcppt::either::map(
                  fcppt::either::from_optional(
                      ...
                      [&_path, this]
                      {
                        return libftl::archive::open_path_error{
                            libftl::archive::open_path_error::variant{
                                libftl::archive::open_path_error::read_error{
                                    .archive_path_ = _path, .file_path_ = this->file_path_}}};
                      }),
